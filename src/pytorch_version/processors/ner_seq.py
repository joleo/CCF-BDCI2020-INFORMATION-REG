...
class CompProcessor(DataProcessor):
    """Processor for the chinese ner data set."""
    ...
    def get_labels(self):
        """See base class."""
        return ["X", "B-QQ","B-address", "B-book", "B-company","B-email", 'B-game', 'B-government', "B-mobile",'B-movie', 'B-name',
                'B-organization', 'B-position','B-scene',"B-vx",
                "I-QQ", "I-address", "I-book", "I-company", "I-email", 'I-game', 'I-government', "I-mobile", 'I-movie', 'I-name',
                'I-organization', 'I-position', 'I-scene', "I-vx",
                "S-QQ", "S-address", "S-book", "S-company", "S-email", 'S-game', 'S-government', "S-mobile", 'S-movie','S-name',
                'S-organization', 'S-position', 'S-scene', "S-vx",
                'O',"[START]", "[END]"]
