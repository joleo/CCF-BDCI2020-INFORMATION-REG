...
class CluenerProcessor(DataProcessor):
    ...
    def get_test_examples(self, data_dir):
        """See base class."""
        testfile = '350_test.json'
        print(f'ues {testfile} for test')
        return self._create_examples(self._read_json(os.path.join(data_dir, testfile)), "test")
...
class CompProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["O", "address", "book","company",'email','game','government','mobile','movie','name','organization','position','scene','QQ','vx']
